...
sigAdj <- sig/(nrow(r.tab)*ncol(r.tab))
sigAdj
# z value
qnorm(sigAdj/2) # above pos/below neg = significant
...
sig <- .05 # significance level
# adjust for multiple testing with Bonferroni
sigAdj <- sig/(nrow(r.tab2)*ncol(r.tab2))
sigAdj
# z value
qnorm(sigAdj/2) # above pos/below neg = significant
...
### Comparison of raw material by site (trinomial)
...
sig <- .05 # significance level
# adjust for multiple testing with Bonferroni
sigAdj <- sig/(nrow(r.tab3)*ncol(r.tab3))
sigAdj
# z value
qnorm(sigAdj/2) # above pos/below neg = significant
